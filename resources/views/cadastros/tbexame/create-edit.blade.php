...
<div class="container">
  ...
  <div class="panel-heading">{{$tbexamesEdit->nome or 'Novo'}}</div>
  ...
  <nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      <a class="nav-item nav-link active" id="nav-dadosPessoais-tab" data-toggle="tab" href="#nav-dadosPessoais" role="tab" aria-controls="nav-dadosPessoais" aria-selected="true">Exames</a>
  ...
  <div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-dadosPessoais" role="tabpanel" aria-labelledby="nav-dadosPessoais-tab">
      ...
      @foreach ($tbexamesEdit as $tbexamesEdit)
      @endforeach
      {!! Form::model($tbexamesEdit, ['route' => ['tbexames.update', $tbexamesEdit->cdExames ], 'enctype' => 'multipart/form-data', 'class' => 'form', 'method' => 'put']) !!}
      @else
      {!! Form::open(['route' => 'tbexames.store', 'enctype' => 'multipart/form-data', 'class' => 'form']) !!}
      @endif
      ...
      <div class="form-row align-items-center">
        <div class="form-group col-sm-6">
          <button type="submit" style="text-align: center;" class="btn btn-primary col-sm-12"><i class="far fa-save" style="font-size:20px;"></i> Solicitar Exames</button>
        </div>
